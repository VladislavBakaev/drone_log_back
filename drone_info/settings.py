"""
Django settings for drone_info project.
...
SECRET_KEY = 'django-insecure-071t1(b9&e#c$1+^w=33&bb4m+w_g@)15@rjyt(uv=&((22&x*'
...
WSGI_APPLICATION = 'drone_info.wsgi.application'
